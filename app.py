...
with st.sidebar:
    ...
    with st.expander("⚙️ Configuración Avanzada del Eje"):
        ...
        incluir_xp = st.checkbox("Incluir Grupo XP (Pacientes sin Egresos)", value=False, help="Agrega a los casos fallecidos sin egreso previo asumiendo 1 día de sobrevida.")
